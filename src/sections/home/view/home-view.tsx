    ...
    <div className="flex flex-col gap-12 md:gap-20 pb-20 w-full">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 pt-8 md:pt-16 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-5 sm:gap-6 z-10 text-center lg:text-left items-center lg:items-start">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#075985] leading-[1.15]">
          ...
          <div className="flex flex-wrap gap-4 mt-2 justify-center lg:justify-start">
            <Link
              href="#features"
              className="bg-white text-[#075985] border-2 border-[#075985]/20 px-6 py-3 sm:px-8 sm:py-3.5 rounded-lg font-bold tracking-wide hover:bg-[#0ea5e9]/5 hover:border-[#075985]/40 transition-all text-sm sm:text-base"
            >
              TÌM HIỂU THÊM
            </Link>
          </div>
        ...
        <div className="relative w-full max-w-[500px] mx-auto aspect-square md:aspect-[4/3] bg-white rounded-3xl shadow-xl border border-[#075985]/10 overflow-hidden group">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 rounded-full border-[8px] border-[#0ea5e9]/10 flex items-center justify-center animate-[spin_20s_linear_infinite]">
              <div className="absolute top-0 w-4 h-4 bg-[#0ea5e9] rounded-full -translate-y-2 shadow-[0_0_15px_#0ea5e9]"></div>
            </div>
            <div className="absolute w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full border-[4px] border-[#075985]/20 border-dashed flex items-center justify-center animate-[spin_15s_linear_infinite_reverse]"></div>

            {/* Icon Y tế ở giữa */}
            <div className="absolute text-[#075985] bg-white p-5 sm:p-6 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-500">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 lg:px-12 w-full pt-6">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#075985] mb-3 sm:mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white p-6 sm:p-8 rounded-2xl shadow-md border border-[#075985]/5 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
            >
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#f0f9ff] text-[#0ea5e9] rounded-xl flex items-center justify-center mb-5 sm:mb-6 group-hover:bg-[#075985] group-hover:text-white transition-colors duration-300">
                {feature.icon}
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-[#075985] mb-2 sm:mb-3">
                {feature.title}
              </h3>
