...
export default function AuthLayout() {
  ...
  return (
    <div className="h-screen w-full bg-primary-50 flex relative overflow-hidden text-primary-900">
      ...
      <div className="w-1/2 h-screen flex flex-col items-center justify-center p-8 md:p-12 lg:p-16">
        ...
        <form className="w-[80%] max-w-[500px] flex flex-col gap-5">
          <input
            ...
            className="w-full px-5 py-4 text-lg rounded-xl border-2 border-primary-900/50 bg-transparent text-primary-900 placeholder-primary-900/60 focus:outline-none focus:border-primary-500 focus:ring-4 focus:ring-primary-500/20 transition-all font-medium"
          />
          <input
            type="password"
          ...
          <button
            type="button"
            className="w-full mt-4 py-4 bg-gradient-to-r from-primary-500 to-primary-900 text-white text-lg font-bold rounded-xl hover:opacity-90 hover:shadow-lg transition-all duration-300
            "
          >
            ĐĂNG KÝ
          </button>
        ...
        <p className="mt-8 text-base md:text-lg font-semibold text-primary-900">
          Bạn đã có tài khoản ?{" "}
          <button
            onClick={toggleMode}
            className="bg-gradient-to-r from-primary-500 to-primary-900 bg-clip-text text-transparent hover:opacity-70 transition-opacity"
          >
            Đăng nhập ngay
          </button>
        </p>
      ...
      <div className="w-1/2 h-screen flex flex-col items-center justify-center p-8 md:p-12 lg:p-16">
        ...
        <form className="w-[80%] max-w-[500px] flex flex-col gap-5">
          ...
          <Link
            href="/dashboard"
            className="w-full mt-4 py-4 bg-gradient-to-r from-primary-500 to-primary-900 text-white text-lg font-bold rounded-xl hover:opacity-90 hover:shadow-lg transition-all duration-300 block text-center"
          >
            ĐĂNG NHẬP
          </Link>
        </form>
      ...
      >
        <div className="relative w-full h-full bg-primary-900">
          ...
          <div
            className={`absolute inset-0 h-screen bg-primary-900 transition-opacity duration-300 ease-in-out ${isSolid ? "opacity-100" : "opacity-0"
              }`}
          ></div>
