...
export default function HomeFooter() {
  ...
  return (
    <footer className="w-full bg-primary-800 text-primary-50 border-t border-primary-50/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          {footerColumns.map((col, index) => (
            <div key={index} className="lg:col-span-3 flex flex-col">
              ...
              <div className="w-10 h-px bg-primary-50 mt-2 mb-5 opacity-60"></div>
              ...
              <ul className="flex flex-col gap-3">
                {col.links.map((link, linkIndex) => (
                  <li key={linkIndex}>
                    ...
                    <Link
                      href="#"
                      className="text-primary-50/80 hover:text-primary-50 text-sm font-medium transition-colors duration-200"
                    >
                      {link}
                    </Link>
                  </li>
