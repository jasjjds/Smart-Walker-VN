    ...
    <header className="h-20 w-full bg-white/60 backdrop-blur-md border-b border-[#0ea5e9]/10 flex items-center justify-between px-4 sm:px-6 lg:px-8 z-10 shadow-sm shrink-0">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <div 
          ...
          className="flex items-center gap-2 sm:gap-3 pl-3 sm:pl-4 border-l border-[#0ea5e9]/20 cursor-pointer group"
        >
          <div className="text-right hidden sm:block">
            <p className="text-xs sm:text-sm font-bold text-[#0c4a6e] leading-tight truncate max-w-[120px]">
              {user?.full_name || 'Unknown'}
            </p>
            <p className="text-[10px] sm:text-xs font-medium text-[#0ea5e9] mt-0.5">
